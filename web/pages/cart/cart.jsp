...
<div id="main">
        ...
        <c:if test="${not empty sessionScope.cart.items}">
            <c:forEach items="${sessionScope.cart.items}" var="entry">
                <tr>
                    ...
                    <td>
                        <input class="updateCount" style="width: 70px;" bikeId="${entry.value.id}" type="text" value="${entry.value.count}">
                    </td>
    ...
    <c:if test="${not empty sessionScope.cart.items}">
        ...
        <div class="cart_info">
            ...
            <span class="cart_span"><a href="client/orderServlet?action=isLogin">去提交</a></span>
        </div>
